...
dataSE<- dataSE[rownames(dataSE) %in% autophagy_genesDE,]
dim(dataSE) 
...
my_palette<-c("#56B4E9", 
              "#F0E442","#D55E00", "#E69F00", "#0072B2", "#009E73",
              "#F0E442","#D55E00", "#E69F00", "#0072B2", "#009E73",
              "#F0E442","#D55E00", "#E69F00", "#0072B2", "#009E73",
              "#F0E442","#D55E00", "#E69F00", "#0072B2")
...
myplclust(hc, labels=as.vector(colnames(averages)), lab.col=as.fumeric(my_palette), cex=0.7)
